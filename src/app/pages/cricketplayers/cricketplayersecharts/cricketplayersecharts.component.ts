...
import { LocalDataSource } from 'ng2-smart-table'; // twitter data of smart table
import { SmartTableService } from '../../../@core/data/smart-table.service'; // twitter data of smart table
import { BsDatepickerConfig } from 'ngx-bootstrap/datepicker'; // twitter data of smart table

@Component({
  selector: 'ngx-echarts',
  styleUrls: ['./cricketplayersecharts.component.scss'],
  templateUrl: './cricketplayersecharts.component.html',
})
export class CricketPlayersEchartsComponent {
